...
3. **Isolate the problem** – create a live example (e.g., on
   [Codepen](http://codepen.io)) of a [reduced test case](http://css-tricks.com/6263-reduced-test-cases/).
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your
   ...
   git remote add upstream https://github.com/olton/reset-css
   ```
...
4. Commit your changes in logical chunks. Please adhere to these [git commit message conventions](http://tbaggery.com/2008/04/19/a-note-about-git-commit-messages.html)
